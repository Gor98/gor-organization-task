...
interface RepositoryContract
{
    ...
    public function delete($object): Mixed;
    public function fetch($object): Model;
    public function find(int $id, array $columns, array $relations, bool$throwException): Mixed;
    public function findBy(array $credentials, array $columns, array $relations, bool $throwException): Mixed;
